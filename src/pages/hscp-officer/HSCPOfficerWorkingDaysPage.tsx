...
export default function HSCPOfficerWorkingDaysPage() {
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Upload the HSCP Grades class calendar used for attendance.
        </p>
      </div>
      <WorkingDaysManager allowRegularCalendar={false} defaultCalendarType="hscp" />
    </div>
  )
}
